...
public class TravelDistanceEventHandler2 implements TransitDriverStartsEventHandler, LinkLeaveEventHandler, PersonEntersVehicleEventHandler, PersonLeavesVehicleEventHandler {
    ...
    public TravelDistanceEventHandler2 (Network network) {
